    ...
    <div className="relative w-full">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-6 lg:gap-8">
        ...
        >
          {/* Corner decorations */}
          <div
            className={`absolute top-0 left-0 w-3 h-3 md:w-4 md:h-4 border-t-2 border-l-2 transition-colors ${activeTrack === "codestellation" ? "border-purple-400" : "border-purple-500/50"}`}
          />
          <div
            className={`absolute top-0 right-0 w-3 h-3 md:w-4 md:h-4 border-t-2 border-r-2 transition-colors ${activeTrack === "codestellation" ? "border-purple-400" : "border-purple-500/50"}`}
          />
          <div
            className={`absolute bottom-0 left-0 w-3 h-3 md:w-4 md:h-4 border-b-2 border-l-2 transition-colors ${activeTrack === "codestellation" ? "border-purple-400" : "border-purple-500/50"}`}
          />
          <div
            className={`absolute bottom-0 right-0 w-3 h-3 md:w-4 md:h-4 border-b-2 border-r-2 transition-colors ${activeTrack === "codestellation" ? "border-purple-400" : "border-purple-500/50"}`}
          />
        ...
        >
          {/* Corner decorations */}
          <div
            className={`absolute top-0 left-0 w-3 h-3 md:w-4 md:h-4 border-t-2 border-l-2 transition-colors ${activeTrack === "decode" ? "border-cyan-400" : "border-cyan-500/50"}`}
          />
          <div
            className={`absolute top-0 right-0 w-3 h-3 md:w-4 md:h-4 border-t-2 border-r-2 transition-colors ${activeTrack === "decode" ? "border-cyan-400" : "border-cyan-500/50"}`}
          />
          <div
            className={`absolute bottom-0 left-0 w-3 h-3 md:w-4 md:h-4 border-b-2 border-l-2 transition-colors ${activeTrack === "decode" ? "border-cyan-400" : "border-cyan-500/50"}`}
          />
          <div
            className={`absolute bottom-0 right-0 w-3 h-3 md:w-4 md:h-4 border-b-2 border-r-2 transition-colors ${activeTrack === "decode" ? "border-cyan-400" : "border-cyan-500/50"}`}
          />
          ...
          <div className="relative p-3 md:p-5 lg:p-7">
            ...
            >
              ...
              <span>
                {selectedTrack === "decode" ? "→ Enter Track" : "Select"}
              </span>
      ...
      <AnimatePresence>
        {selectedTrack && (
          ...
          >
            <div
              className={`inline-flex items-center gap-1.5 md:gap-3 px-2.5 py-1 md:px-6 md:py-3 font-mono text-[8px] md:text-xs backdrop-blur-sm border rounded
              ${
                selectedTrack === "codestellation"
            ...
            >
              <div
                className={`w-1 h-1 md:w-2 md:h-2 animate-pulse ${selectedTrack === "codestellation" ? "bg-purple-400" : "bg-cyan-400"}`}
              />
              <span className="hidden md:inline">TRACK LOCKED - Press</span>
              <span className="md:hidden">LOCKED - Click again</span>
              <kbd
                className={`px-1.5 py-0.5 md:px-2 md:py-1 border rounded hidden md:inline font-bold
                ${
                  selectedTrack === "codestellation"
              ...
              <kbd
                className={`hidden md:inline-block px-2 py-1 border rounded font-bold
                ${
                  selectedTrack === "codestellation"
                    ? "bg-purple-500/20 border-purple-400/30"
                    : "bg-cyan-500/20 border-cyan-400/30"
