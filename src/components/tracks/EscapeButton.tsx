...
export default function EscapeButton() {
  ...
  const accentColor = navMeta.currentMeta?.track === 'codestellation' ? 'purple' : 'cyan'
  ...
  return (
    ...
    >
      <Link href="/">
        ...
        >
          {/* Corner decorations */}
          <div className={`absolute -top-0.5 -left-0.5 w-2 h-2 md:w-2.5 md:h-2.5 border-t-2 border-l-2 transition-colors ${accentColor === 'purple' ? 'border-purple-400/60 group-hover:border-purple-400' : 'border-cyan-400/60 group-hover:border-cyan-400'}`} />
          <div className={`absolute -bottom-0.5 -right-0.5 w-2 h-2 md:w-2.5 md:h-2.5 border-b-2 border-r-2 transition-colors ${accentColor === 'purple' ? 'border-purple-400/60 group-hover:border-purple-400' : 'border-cyan-400/60 group-hover:border-cyan-400'}`} />
          ...
          <span className={`relative text-[8px] md:text-[10px] border px-1.5 py-0.5 rounded ${accentColor === 'purple' ? 'text-purple-500/60 border-purple-500/30' : 'text-cyan-500/60 border-cyan-500/30'}`}>
            ESC
          </span>
      ...
      <div className={`hidden md:block mt-1 text-[9px] font-mono tracking-widest ${accentColor === 'purple' ? 'text-purple-500/30' : 'text-cyan-500/30'}`}>
        RETURN_TO_ROOT
      </div>
    </motion.div>
  )
