...
import type { TrackSection } from "@/store/useNavMeta";
...
export default function TracksSectionsContainer({
  children,
}: {
  ...
  const handleSceneChange = useEffectEvent(
    (newKey: TrackSection, newDirection: 1 | -1) => {
