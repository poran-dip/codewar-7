      ...
      >
          ...
          <div className="relative bg-black/40 backdrop-blur-md border-2 border-cyan-500/50 px-3 py-2 md:px-6 md:py-3 clip-path-[polygon(12px_0,100%_0,100%_calc(100%-12px),calc(100%-12px)_100%,0_100%,0_12px)] md:clip-path-[polygon(16px_0,100%_0,100%_calc(100%-16px),calc(100%-16px)_100%,0_100%,0_16px)]">
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2 md:gap-3">
                <Trophy className="w-3 h-3 md:w-4 md:h-4 text-cyan-400 animate-pulse" />
            ...
            >
              ...
              <div className="relative flex items-center justify-between gap-3 md:gap-4">
                ...
                <div className="flex items-center gap-2 md:gap-3 flex-1 min-w-0">
                  <div className="p-1.5 md:p-2.5 bg-cyan-500/10 border-2 border-cyan-400/20 rounded group-hover:scale-110 group-hover:bg-cyan-500/20 transition-all shrink-0">
                    <prize.icon
                  ...
                  <div className="flex-1 min-w-0">
                    <h3 className="text-xs md:text-base font-mono font-bold text-cyan-200 mb-0.5">
                      {prize.title}
                    </h3>
                    <p className="text-[10px] md:text-xs text-cyan-100/60 font-mono">
                      {prize.text}
                    </p>
                  </div>
                </div>
                ...
                <div className="text-right shrink-0">
                  <div className="text-base md:text-2xl font-mono font-black text-white drop-shadow-[0_0_10px_rgba(255,255,255,0.3)]">
                    {prize.reward}
                    <p className="text-[8px] md:text-[9px] font-mono text-cyan-400/50 mt-0.5 max-w-35 md:max-w-80">
                      + {prize.sponsorPerks}
                    </p>
                  </div>
                </div>
        ...
        >
          ...
          <div className="relative space-y-1.5 md:space-y-2 text-center">
            ...
            <p className="text-[9px] md:text-[10px] font-mono text-cyan-400/50">
              + official leaderboard listing
            </p>
          </div>
        </motion.div>
