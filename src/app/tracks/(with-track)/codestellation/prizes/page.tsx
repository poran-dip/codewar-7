  ...
  return (
    <section className="h-screen flex items-center justify-center px-4">
      ...
      >
            ...
            >
              ...
              <div className="relative flex items-center justify-between gap-4">
                ...
                <div className="flex items-center gap-3 flex-1 min-w-0">
                  <div className="p-2.5 bg-purple-500/10 border-2 border-purple-400/20 rounded group-hover:scale-110 group-hover:bg-purple-500/20 transition-all shrink-0">
                    <prize.icon className={`w-5 h-5 ${prize.iconColor} ${prize.iconGlow}`} />
                  </div>

                  <div className="flex-1 min-w-0">
                    <h3 className="text-sm md:text-base font-mono font-bold text-purple-200 mb-0.5">
                      {prize.title}
                    </h3>
                    <p className="text-xs text-purple-100/60 font-mono">
                      {prize.text}
                    </p>
                  </div>
                </div>
        ...
        <div className="mt-3 text-center text-[10px] font-mono text-purple-500/30 tracking-widest">
          REWARD_SYSTEM_v1.0
        </div>
      </motion.div>
    </section>
